	...
	Scanner input = new Scanner(System.in);
	  ...
	  //  public int[][] EvaluationMinMax = new int [700][5];
	    ...
	    public DebugMode() {
			...
			//int[][] ScoringBoard = new int[SIZE][SIZE];
	    ...
	    public void PlayerInput(DebugMode game){
	    	...
	    	game.PrintBoard();
	    	System.out.println("[NOTE: All board states below this represents the board after the move is made.]");
	    	
//	    	System.out.println("Select the X-Axis of the piece you want to move: ");
//	    	PlayerChoice[0] = input.nextInt();
//	    	System.out.println("Select the Y-Axis of the piece you want to move: ");
//	    	PlayerChoice[1] = input.nextInt();
//	    	
//	    	int[][] result = game.validMove(PlayerChoice,game.board,whosemove);
//	    	
//	    	int counter = 0;
//	    	
//	    	
//	    	System.out.println("The Possible Move for: "+PlayerChoice[0]+","+PlayerChoice[1]);
//	    	
//	    	while (counter<10 && result[counter][0]==1 ){
//	    		
//	    		int counter2 = 1;
//	    		System.out.println("");
//	    		
//	    		while (counter2<12){
//	    			
//	    			System.out.print(result[counter][counter2]);
//	    			counter2++;
//	    		}
//	    		
//	    		System.out.println("");
...
//		    while (x<EvaluationMinMax.length && EvaluationMinMax[x][0]!=0){
//		    	
//		    	System.out.println(""+(EvaluationMinMax[x][0])+""+(EvaluationMinMax [x][1])+""+(EvaluationMinMax[x][2])+""+(EvaluationMinMax[x][3])+""+EvaluationMinMax[x][4]);
//		    	
//		    	x++;
//		    }
	    	...
	    	while(Level1Node[z][0]!=0){
	    		...
	    		//System.out.println(Level1Node[z][1]+" "+Level1Node[z][2]);
...
//	    			    		EvaluationMinMax[CounterGlobal][1]= ValidMovesCounter+1;
//	    			    		EvaluationMinMax[CounterGlobal][2]= 0;
//	    			    		EvaluationMinMax[CounterGlobal][3]= MiniMaxEvaluate[ValidMovesCounter][0];
//	    			    		EvaluationMinMax[CounterGlobal][4]= TieBreakerScore;
//	    			    		CounterGlobal++;
	    	...
	    	System.out.println("Level 2 Minimum of "+MoveNumber+": ("+Min1+","+Min2+")");
	    	...
	    	System.out.println("Current Best Beta: "+BetaOwner+" || "+Beta1+"."+Beta2);
...
//	    			    		EvaluationMinMax[CounterGlobal][4]= Result[1];
	    	...
	    	System.out.println("Level 3 Maximum of "+MoveNumber+"."+MoveNumber2+": ("+Max1+","+Max2+")");
...
;
	    			...
	    			if ((Level3Node[x][1]>Alpha && Level3Node[x][2]>Alpha2) || Level3Node[x][1]>Alpha || (Level3Node[x][1]==Alpha && Level3Node[x][2]>Alpha2 ) || (Level3Node[x][1]==Alpha && Level3Node[x][2]==Alpha2 )){
	    				...
	    				AlphaBetaSteps++;
	    				System.out.println("("+AlphaBetaSteps+") Alpha Beta Probing Rejected "+MoveNumber+"."+MoveNumber2+"."+(x+1)+" -- Will not resume probing as the Alpha value for this child ["+Level3Node[x][1]+","+Level3Node[x][2]+"] is higher or equal to current best Alpha value.");	
	    				//System.out.println(" ("+Level3Node[x][1]+"."+Level3Node[x][2]+")");
	    				flag=1;
	    	...
	    	System.out.println("Current Best Alpha Value for Node "+MoveNumber+" : ["+Alpha+","+Alpha2+"].");
    	
	    	if (((Alpha<Beta1 || (Alpha==Beta1 && Alpha2<Beta2) || (Alpha==Beta1 && Alpha2==Beta2 ))&& MoveNumber!=1)){
	    		
	    		
	    		
	    		System.out.println("[Alert!]: All remaining child of Node ["+MoveNumber+"] will not be probed as the current Alpha value of ["+Alpha+","+Alpha2+"] is lower or equal than current Best Beta value of ["+Beta1+","+Beta2+"] owned by Node: "+BetaOwner);
	    		BetaFlag=1;
...
//	    	System.out.println("MoveNumber: "+MoveNumber);
	    ...
	    public int[] Minimax3(int[] MoveData,char[][] OriginalBoard){
			...
			//Add Tie Breaker
		 	...
		 	System.out.println("                                                      0 1 2 3 4 5 6 7     [MiniMax3] Final Score = ["+FinalScore+"] Scores("+whosemove+") = "+NumberOfFriendly+"(Friend)  "+NumberOfEnemy+"(Enemy) Tie BreakerScore: ["+ScoringBoard[MoveData[2]][MoveData[3]]+"]");
		 	...
		 	//ListPossibleMoveMiniMax2(TemporaryBoard2,EnemyMove,MoveNumber,TieBreakerScore);
